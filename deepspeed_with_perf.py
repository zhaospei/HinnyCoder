...
from transformers import AutoModelForSeq2SeqLM, AutoModelForCausalLM, AutoTokenizer, get_linear_schedule_with_warmup, set_seed
...
def main():
    ...
    text_column = "masked_contract"
    label_column = "func_body"
    lr = 3e-3
    num_epochs = 1
    batch_size = 2
    seed = 42
    ...
    def preprocess_function(examples):
        ...
        labels = tokenizer(
            targets, max_length=2048, padding="max_length", truncation=True, return_tensors="pt"
        )
